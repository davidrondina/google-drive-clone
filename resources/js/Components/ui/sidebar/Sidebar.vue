...
<template>
    <div v-if="collapsible === 'none'"
        :class="cn('flex h-full w-[--sidebar-width] flex-col text-sidebar-foreground', props.class)" v-bind="$attrs">
        <slot />
    </div>
    ...
    <div v-else class="hidden group peer md:block" :data-state="state"
